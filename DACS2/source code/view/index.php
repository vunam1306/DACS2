...
<body data-bs-spy="scroll" data-bs-target=".navbar" data-bs-offset="50">
   ...
   <div class="header">
    <nav>
      ...
      <form action="search.php" class="input" method="get">
        <div class="search">
          <input type="text" name="search_inp" id="" placeholder="Search">
        </div>
      ...
      <div class="offcanvas offcanvas-start" id="demo">
        ...
        <div class="offcanvas-body">
          ...
          <li role="presentation" class="nav-item"><a class="nav-link" role="menuitem" tabindex="-1" href="../view/login.php"><p>Login</p></a></li>
